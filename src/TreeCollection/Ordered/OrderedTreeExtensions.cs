...
public static partial class IOrderedTreeExtension
{
            ...
            where TNode : IOrderedTree<TValue, TNode>
    {
        ...
        public TNode AddAt(Index index, TNode node)
        {
            return instance.AddAt(index.GetOffset(instance.Count), node);
        }

        /// <inheritdoc cref="IOrderedTree{TValue, TNode}.AddAt(int, IEnumerable{TNode})"/>
        public void AddAt(Index index, IEnumerable<TNode> nodes)
        {
            instance.AddAt(index.GetOffset(instance.Count), nodes);
        }

        /// <inheritdoc cref="IOrderedTree{TValue, TNode}.AddAt(int, ReadOnlySpan{TNode})"/>
        public void AddAt(Index index, params ReadOnlySpan<TNode> nodes)
        {
            instance.AddAt(index.GetOffset(instance.Count), nodes);
        }

        /// <inheritdoc cref="IOrderedTree{TValue, TNode}.AddAt(int, TValue)"/>
        public TNode AddAt(Index index, TValue value)
        {
            return instance.AddAt(index.GetOffset(instance.Count), value);
        }

        /// <inheritdoc cref="IOrderedTree{TValue, TNode}.AddAt(int, IEnumerable{TValue})"/>
        public void AddAt(Index index, params IEnumerable<TValue> nodes)
        {
            instance.AddAt(index.GetOffset(instance.Count), nodes);
        }
        ...
        {
            return instance.AddAt(instance.Count, node);
        }

        /// <inheritdoc cref="Add{TValue, TNode}(IOrderedTree{TValue, TNode}, TNode)"/>
        public void Add(IEnumerable<TNode> nodes)
        {
            instance.AddAt(instance.Count, nodes);
        }

        /// <inheritdoc cref="Add{TValue, TNode}(IOrderedTree{TValue, TNode}, TNode)"/>

        public void Add(params ReadOnlySpan<TNode> nodes)
        {
            instance.AddAt(instance.Count, nodes);
        }
        ...
        /// 将值添加到最后
        /// </summary>
        public TNode Add(TValue value)
        {
            return instance.AddAt(instance.Count, value);
        }

        /// <inheritdoc cref="Add{TValue, TNode}(IOrderedTree{TValue, TNode}, TNode)"/>
        public void Add(params IEnumerable<TValue> values)
        {
            instance.AddAt(instance.Count, values);
        }
        ...
        {
            return instance.AddAt(0, node);
        }

        /// <inheritdoc cref="AddFirst{TValue, TNode}(IOrderedTree{TValue, TNode}, TNode)"/>
        public void AddFirst(IEnumerable<TNode> nodes)
        {
            instance.AddAt(0, nodes);
        }

        /// <inheritdoc cref="AddFirst{TValue, TNode}(IOrderedTree{TValue, TNode}, TNode)"/>
        public void AddFirst(params ReadOnlySpan<TNode> nodes)
        {
            instance.AddAt(0, nodes);
        }
        ...
        /// 将值添加到开头
        /// </summary>
        public TNode AddFirst(TValue value)
        {
            return instance.AddAt(0, value);
        }

        /// <inheritdoc cref="AddFirst{TValue, TNode}(IOrderedTree{TValue, TNode}, TValue)"/>
        public void AddFirst(params IEnumerable<TValue> values)
        {
            instance.AddAt(0, values);
        }

        /// <summary>
        /// 将节点添加到自己的前面
        /// </summary>
        public TNode AddBefore(TNode node)
        {
            return instance.RequiredParent.AddAt(instance.Index, node);
        }

        /// <inheritdoc cref="AddBefore{TValue, TNode}(IOrderedTree{TValue, TNode}, TNode)"/>
        public TNode AddBefore(TValue value)
        {
            return instance.RequiredParent.AddAt(instance.Index, value);
        }

        /// <summary>
        /// 将节点添加到自己的后面
        /// </summary>
        public TNode AddAfter(TNode newNode)
        {
            return instance.RequiredParent.AddAt(instance.Index + 1, newNode);
        }

        /// <inheritdoc cref="AddAfter{TValue, TNode}(IOrderedTree{TValue, TNode}, TNode)"/>
        public TNode AddAfter(TValue value)
        {
            return instance.RequiredParent.AddAt(instance.Index + 1, value);
        }

        /// <inheritdoc cref="IOrderedTree{TValue, TNode}.Remove(TValue)"/>
        public TNode? Remove(TValue value, Range? range = null)
        {
            return range is not Range ran
            ? instance.Remove(value)
            : instance[ran].Remove(value);
        }

        /// <inheritdoc cref="IOrderedTree{TValue, TNode}.RemoveAt(int)"/>
        public TNode? RemoveAt(Index index)
        {
            return instance.RemoveAt(index.GetOffset(instance.Count));
        }

        /// <inheritdoc cref="IOrderedTree{TValue, TNode}.RemoveAll(Predicate{TNode})"/>
        public int RemoveAll(Predicate<TNode>? match = null, Range? range = null)
        {
            return range is not Range ran
        ...
        /// <inheritdoc cref="IOrderedTree{TValue, TNode}.RemoveAll(Predicate{TNode})"/>
        public int RemoveAll(Predicate<TValue>? match = null, Range? range = null)
        {
            return (range, match) switch {
        ...
        public void MoveChild(Index fromIndex, Index toIndex)
        {
            instance.MoveChild(
        ...
        public bool Contains(TValue value, Range? range = null)
        {
            return range is not Range ran
        ...
        public int IndexOf(TValue value, Range? range = null)
        {
            return range is not Range ran
        ...
        public int LastIndexOf(TValue value, Range? range = null)
        {
            return range is not Range ran
        ...
        public void UpdateIndex(Range range)
        {
            instance[range].UpdateIndex();
        }
    }
}